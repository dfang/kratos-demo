...
const (
	PositionService_ListPosition_FullMethodName   = "/api.user.v1.PositionService/ListPosition"
	PositionService_GetPosition_FullMethodName    = "/api.user.v1.PositionService/GetPosition"
	PositionService_CreatePosition_FullMethodName = "/api.user.v1.PositionService/CreatePosition"
	PositionService_UpdatePosition_FullMethodName = "/api.user.v1.PositionService/UpdatePosition"
	PositionService_DeletePosition_FullMethodName = "/api.user.v1.PositionService/DeletePosition"
)
...
var PositionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.user.v1.PositionService",
	...
	Metadata: "user/v1/position.proto",
}
